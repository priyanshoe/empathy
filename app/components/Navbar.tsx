...
export default function Navbar(){
    ...
    return(
        <div className="main relative font-[demo4]  ">
            <div className="z-99 absolute w-9/10 top-4 left-1/20 flex justify-between items-center pr-5 lg:px-8 border-[#394353] border-1">
                
                <div className="hidden lg:block ">
                    <h2><Link href='/'>OUR REEL</Link></h2>
                </div>
                
                <div className="h-full flex justify-center items-center border-[#394353] py-3 px-5 border-r-2 lg:border-l-2">
                ...
                <div className="flex justify-between items-center md:w-1/4 lg:w-1/5 ">
                    ...
                    <div className="hidden md:block h-[1px] w-12 bg-[#394353]"></div>
                    {
                        isOpen ?
            ...
            <div className={`z-10 h-screen w-full bg-[#181C22] absolute top-0 left-0 ${isOpen ? 'translate-y-0' : '-translate-y-[100%]'}
                ...
                <ul className="navlink text-transparent text-4xl flex flex-col justify-between h-3/7">
                    <li>Home</li>
                    <li>Services</li>
                    <li>About</li>
                    <li>Projects</li>
